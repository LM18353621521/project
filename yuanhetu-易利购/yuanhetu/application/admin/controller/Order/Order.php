...
class Order extends Base {
    ...
    public function ajaxindex(){
        ...
        $order_prom_id ? $condition['user_id'] = trim($order_prom_id) : false;//用户ID
        ...
        foreach($orderList as $key=>$value){
            $order_goods=M('order_goods')->where('order_id',$value['order_id'])->find();
            $orderList[$key]['goods_id']=$order_goods['goods_id'];
            $orderList[$key]['goods_name']=$order_goods['goods_name'];
        }
