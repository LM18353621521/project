...
class Goods extends Base {
    ...
    public function ajaxGoodsList(){
        ...
        */
        ...
        foreach ($goodsList as $k=>$v){
            $goodsList[$k]['stock']=M('goods_setmeal')->where('goods_id',$v['goods_id'])->sum('stock');
        }
    ...
    public function addEditGoods()
    {
        ...
        if ((I('is_ajax') == 1) && IS_POST) {
            ...
            $data = input('post.');
            if($type == 1 && $data['status']==0&&$data['type_id']==6){
                $data['store_count']=0;
            }
            $errors = [];
...
//                    $this->ajaxReturns('商品分类必选');
                ...
                if(empty($data['cost_price'])){
                    $errors['cost_price'] = '购物积分必填';
//                    $this->ajaxReturns('购物积分必填');
                }
