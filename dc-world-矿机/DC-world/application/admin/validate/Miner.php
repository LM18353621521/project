...
use think\Validate;
use think\Db;
class Miner extends Validate
{

    // 验证规则
    protected $rule = [
        'miner_id'              =>'checkGoodsId',
        'miner_name'            => 'require|min:2|max:150|unique:world_miner',
        'cat_id'                => 'number|gt:0',
//        'goods_sn'              =>'unique:goods|max:20',
//        'miner_price'            =>['require','regex'=>'([1-9]\d*(\.\d*[1-9])?)|(0\.\d*[1-9])'],
...
//        'exchange_integral'     =>'checkExchangeIntegral',
    ...
    //错误信息
    protected $message  = [
        'miner_name.require'                            => '商品名称必填',
        'miner_name.min'                                => '名称长度至少3个字符',
        'miner_name.max'                                => '名称长度至多50个汉字',
        'miner_name.unique'                             => '商品名称重复',
        'cat_id.number'                                 => '商品分类必须填写',
        'cat_id.gt'                                     => '商品分类必须选择',
//        'goods_sn.unique'                               => '商品货号重复',
//        'goods_sn.max'                                  => '商品货号超过长度限制',
//        'goods_num.checkGoodsNum'                       => '抢购数量不能大于库存数量',
//        'miner_price.require'                            => '本店售价必须',
//        'miner_price.regex'                              => '本店售价格式不对',
