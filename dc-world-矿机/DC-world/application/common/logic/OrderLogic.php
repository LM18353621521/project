...
class OrderLogic
{
	 ...
	 * @return array
	 */
	public function addOrder($user_id,$suppliers_id,$address_id,$shipping_code,$invoice_title,$coupon_id = 0,$car_price=[],$user_note='',$pay_name='',$order_type = 0,$start_server_time = 0,$end_server_time = 0)
	{
