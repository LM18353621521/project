    ...
    public function cart2(){
        ...
        if($action == 'buy_now'){
            ...
            if($goods['type_id'] == 6 && $goods['status'] == 1){
                ...
                if($goods_num['num']+$order_num['sums'] > $goods['limit_num'] || $goods_num['num'] > $goods['limit_num']){
...
//        dump($result);exit;
        ...
        $car_price = array(
            ...
            'goods_integral'     => $result['result']['goods_integral'],// 商品兑换积分
    ...
    public function cart4(){
        ...
        if(empty($order_id)){
            ...
            // 获取数据
            $list = $this->request->post()?:$this->request->get();
            ...
            if(empty($address_list)){
                header("Location: ".U('Mobile/User/add_address',array('source'=>'cart4','setmeal_id'=>$list['setmeal'],'goods_num'=>$list['num'])));
                exit;
            }
