...
//						array('name'=>'季度奖测试','act'=>'quarter_check','op'=>'Systems'),
				)),
...
//						array('name'=>'会员升级管理','act'=>'user_level_up','op'=>'User'),
...
//				)),
	...
	'users' =>array('name'=>'会员','child'=>array(
			array('name' => '会员','child'=>array(
				array('name'=>'会员列表','act'=>'index','op'=>'User'),
				array('name'=>'会员等级','act'=>'levelList','op'=>'User'),
				array('name'=>'充值记录','act'=>'recharge','op'=>'User'),
				...
				array('name'=>'汇款记录','act'=>'remittance','op'=>'User'),
//				array('name'=>'会员升级管理','act'=>'user_level_up','op'=>'User'),
                array('name'=>'赠送名额管理','act'=>'quota_management','op'=>'User'),
                array('name'=>'海报设置','act'=>'poster','op'=>'User'),
                array('name'=>'海报添加','act'=>'addPoster','op'=>'User'),
				//array('name'=>'会员整合','act'=>'integrate','op'=>'User'),
				//array('name'=>'会员签到','act'=>'signList','op'=>'User'),
			)),
		)
	),
	'good'=>array('name'=>'商品','child'=>array(
		array('name' => '商品','child' => array(
			array('name' => '商品列表', 'act'=>'goodsList', 'op'=>'Goods'),
			array('name' => '商品分类', 'act'=>'categoryList', 'op'=>'Goods'),
			array('name' => '身份产品系列', 'act'=>'type_identity_list', 'op'=>'Goods'),
...
//					array('name' => '退换货', 'act'=>'return_list', 'op'=>'Order'),
	...
	'promotion'=>array('name'=>'优惠券','child'=>array(
...
//			array('name' => '分销设置', 'act'=>'index', 'op'=>'Distribut'),
//			array('name' => '分销商品列表', 'act'=>'goods_list', 'op'=>'Distribut'),
	...
	'wechat'=>array('name'=>'微信','child'=>array(
		array('name' => '微信','child' => array(
            ...
            array('name' => '一键关注设置', 'act'=>'follow','op'=>'Wechat'),
	...
	'statistics'=>array('name'=>'统计','child'=>array(
		array('name' => '统计','child' => array(
			...
			array('name' => '当前奖池', 'act'=>'jackpot', 'op'=>'Report'),
			array('name' => '奖池记录', 'act'=>'jackpot_log', 'op'=>'Report'),
			array('name' => '市销售统计','act'=>'cityTurnover','op'=>'Report'),
			array('name' => '区销售统计','act'=>'districtTurnover','op'=>'Report'),
		)),
	)),
