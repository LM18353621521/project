...
//                $user['discount'] = (empty($user['discount'])) ? 1 : $user['discount'];
        ...
        $buyGoods = [
            ...
            'member_goods_price'=>$this->goods['shop_price']* $user['discount'],
        ...
        if(empty($this->specGoodsPrice)){
            ...
            $buyGoods['member_goods_price'] = $this->specGoodsPrice['price']* $user['discount'];
