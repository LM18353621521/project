...
Page({
  ...
  getAddress: function () {
    ...
    console.log('globalData:' + app.globalData.routine_openid);
    wx.request({
      url: app.globalData.url + '/routine/auth_api/user_address_list?uid=' + app.globalData.uid + '&openid=' + app.globalData.routine_openid,
      method: 'POST',
      header: header,
      success: function (res) {
        if (res.data.code == 200) {
